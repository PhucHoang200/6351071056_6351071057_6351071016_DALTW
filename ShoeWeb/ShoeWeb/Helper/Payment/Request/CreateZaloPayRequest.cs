...
using ShoeWeb.Helper.Payment.Response;
using System;
...
namespace ShoeWeb.Helper.Payment.Request
{
    public class CreateZaloPayRequest
    {
        ...
        public void MakeSignture(string key)
        {
            var data = AppId + "|" + AppTransId + "|" + AppUser + "|" + Amount + "|" + AppTime + "|" + AppTime + "|" + "|";

            this.Mac = Helper.PasswordHasher.HashPasswordWithSalt(data, key);
        }
