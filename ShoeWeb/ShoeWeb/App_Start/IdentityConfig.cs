...
namespace ShoeWeb.App_Start
{
    public class EmailService : IIdentityMessageService
    {
        public async Task SendAsync(IdentityMessage message)
        {
            var client = new SmtpClient
            {
                ...
                Credentials = new NetworkCredential("6351071016@st.utc2.edu.vn", "Thanhdat123@@@"),
                EnableSsl = true,
            };

            var from = new MailAddress("6351071016@st.utc2.edu.vn", "Admin Shoe Web");
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        //public static async Task<bool> IsConfirmAccount(string email, IOwinContext context)
        //{
        //    var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<ApplicationDbContext>()));
        //    var a = await manager.ConfirmEmailAsync(email).Result;
        //}
